...
namespace SimpleEchoBot.Classes
{
    public class Translator
    {
        ...
        public async static Task<string> TranslateSentenceAsync(string originalSentence)
        {
            ...
            using (var request = new HttpRequestMessage())
            {
                ...
                request.RequestUri = new Uri(String.Format("https://api.cognitive.microsofttranslator.com/translate?api-version=3.0&to={0}", languageCode));
